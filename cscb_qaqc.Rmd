...
odk_sums_install_check <- odk_sums_install %>% 
  dplyr::select("HHID","fieldworker","group","datetime_install",
                "A_BG_visit1-gps-Latitude","A_BG_visit1-gps-Longitude",
                "Status","B1_SUMstove","B3_SUMID")
...
odk_sums_download_check <- odk_sums_download %>% 
  dplyr::select(c("HHID","fieldworker","group","datetime_download",
                  "A_BG_visit1-gps-Latitude","A_BG_visit1-gps-Longitude",,"B3_sumid",
                  "B4_stove","B13_dlsuccess","B15_1_filename",
                  "B16_maxtemp","B17_mintemp","B18_dlfailure"))
...
odk_check <- odk_start %>% 
  dplyr::select(HHID,fieldworker,group,KEY,datetime_pe,datetime_hap,`C_PE-C0_PEUPASID`,`B_HAP-B0_HAPUPASID`) %>% 
  dplyr::full_join(odk_end %>% 
                     dplyr::select(HHID,fieldworker,group,datetime_end,`E_SampleEnd-E24_notes`))
