---
title: "cscb_qaqc"
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = paste0('Results',substr(inputFile,1,nchar(inputFile)-4),Sys.Date(),'.html')) })
